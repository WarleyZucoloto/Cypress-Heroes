...
describe('HeroCard', () => {
    ...
    it('mounts', () => {
        cy.mount(_jsx(HeroCard, { hero: hero }));
    });
    ...
    it('clicking like button should call onLikeHero', () => {
        cy.mount(_jsx(HeroCard, { hero: hero, onLikeHero: cy.spy().as('onLikeHero') }));
    ...
    it('clicking hire button should call onHireHero', () => {
        cy.mount(_jsx(HeroCard, { hero: hero, onHireHero: cy.spy().as('onHireHero') }));
    ...
    describe('when user is logged in', () => {
        ...
        it('when normal user is logged in, edit and delete buttons should NOT exist', () => {
            cy.mount(_jsx(HeroCard, { hero: hero, user: user }));
            cy.get('[data-cy=pencil]').should('not.exist');
            cy.get('[data-cy=trash]').should('not.exist');
        });
    });
    describe('when admin is logged in', () => {
        ...
        it('clicking delete button should call onDeleteHero', () => {
            cy.mount(_jsx(HeroCard, { hero: hero, user: user, onDeleteHero: cy.spy().as('onDeleteHero') }));
        ...
        it('clicking edit button should call onEditHero', () => {
            cy.mount(_jsx(HeroCard, { hero: hero, user: user, onEditHero: cy.spy().as('onEditHero') }));
