...
function isSessionValid(authResult) {
...
function getAuthResultFromLocalStorage() {
    const authResult = JSON.parse(localStorage.getItem(authResultKey) || `{"expiresAt": 0}`);
    return authResult;
}
function saveAuthResultToLocalStorage(authResult) {
