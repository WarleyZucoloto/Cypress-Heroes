...
export function useHeroes() {
    ...
    const deleteHero = (hero) => deleteMutation.mutate(hero);
    return {
        getHeroes,
        getHero,
        createHero,
