...
describe('HeroEditPage', () => {
    ...
    beforeEach(() => {
        ...
        cy.intercept('PUT', '/heroes/1', { statusCode: 200, body: hero }).as('updateRequest');
    });
    it('navigates to the home page when hero is saved', () => {
        cy.mountWithProviders(_jsx(HeroEditPage, {}), routePath, initialPath);
        cy.get('button').contains('Submit').click();
        cy.get('@navigateSpy').should('have.been.calledWithMatch', {
            pathname: '/',
        });
    });
